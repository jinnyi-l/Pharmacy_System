<template>
  <div class="transitOrder">
    <el-breadcrumb separator="/" class="drugRecommend-breadcrumb">
      ...
      >
      <el-breadcrumb-item
        ><span style="font-size: 18px">运输中订单</span></el-breadcrumb-item
      >
    </el-breadcrumb>
    ...
    <div class="center">
      ...
      <div class="table">
        <el-table :data="transitOrders" v-loading="loading" style="width: 100%">
...
export default {
  ...
  watch: {
    current: "getTransitOrderList",
    pageSize: "getTransitOrderList",
  },
  created() {
    this.getTransitOrderList();
  },
  methods: {
    // 获取运输中订单
    getTransitOrderList() {
      ...
      if (this.flag == 0) {
        this.$axios
          ...
          .then((res) => {
            console.log("运输中订单==>", res);
            this.transitOrders = res.data.data.responseBody.orderList;
